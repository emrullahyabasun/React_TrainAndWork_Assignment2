          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="section-title-area text-center">
                ...
                <p className="section-subtitle">Your Satisfaction defines our Success</p>
              </div>
            </div>
          </div>
          <div className="row">
              ...
              <div className="team-member-wrapper">
                <div className="row">
                  <div className="col-lg-3 col-sm-6">
                    ...
                    <div className="single-team-member">
                      <div className="single-team-member__image">
                        <img src="assets/img/about/team-member-1.png" className="img-fluid" alt=""/>
                      </div>
                      <div className="single-team-member__content">
                        <h3 className="name">Tiny Boer</h3>
                        <h4 className="designation">CEO</h4>
                        <p className="short-desc">Tiny's focus is clear: Deliver the best possible customer experience for each of their clients. She works with all team members to ensure that goal is met - each and every day.</p>
                  ...
                  <div className="col-lg-3 col-sm-6">
                    ...
                    <div className="single-team-member">
                      <div className="single-team-member__image">
                        <img src="assets/img/about/team-member-2.png" className="img-fluid" alt=""/>
                      </div>
                      <div className="single-team-member__content">
                        <h3 className="name">John Wilson</h3>
                        <h4 className="designation">Manager</h4>
                        <p className="short-desc">John has always focused on exceptional customer service, attention to detail and offering a friendly, professional and detail-oriented approach for every customer shopping with his team.</p>
                  ...
                  <div className="col-lg-3 col-sm-6">
                    ...
                    <div className="single-team-member">
                      <div className="single-team-member__image">
                        <img src="assets/img/about/team-member-3.png" className="img-fluid" alt=""/>
                      </div>
                      <div className="single-team-member__content">
                        <h3 className="name">Charlotte Hill</h3>
                        <h4 className="designation">Design</h4>
                        <p className="short-desc">"I create environments that compliment your daily life, from a sanctuary for a good night's sleep to a welcoming home to share with family and friends. Color is a key element to any design project".</p>
                  ...
                  <div className="col-lg-3 col-sm-6">
                    ...
                    <div className="single-team-member">
                      <div className="single-team-member__image">
                        <img src="assets/img/about/team-member-4.png" className="img-fluid" alt=""/>
                      </div>
                      <div className="single-team-member__content">
                        <h3 className="name">Jim Shafer</h3>
                        <h4 className="designation">Marketing</h4>
                        <p className="short-desc">Jim has over 25 years' experience in the Marketing and Advertising world. He held several senior marketing roles in the automotive business working for Volvo Cars of North America, LLC.</p>
